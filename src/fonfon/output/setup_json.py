"""JSON renderer for SetupReport — emits parseable JSON via rich's print_json."""

from rich.console import Console

from fonfon.models_setup import SetupReport


def render(report: SetupReport, console: Console) -> None:
    """Emit the full SetupReport as compact JSON.
